...
const fetchingdatafor_extra_div = async () =>{
    ...
    res.map((el) => {
        ...
        let p_div7 = document.createElement("p");
        p_div7.setAttribute("class", 'heart_icon');
        // let main = `${el.title}_${el.}`
        p_div7.innerHTML = `<i class="fa-solid fa-heart testing" value="10"></i>`;
        p_div7.addEventListener("click", ()=>{
            let check = document.querySelector(".testing");
            
            console.log(check.value);
            // let to_change_to_red = document.getElementById("test");
            // to_change_to_red.classList.toggle("to_change_red");
        })
        p_div7.addEventListener("click", function() {addingtowishlistforop(el)});
        // div7.append(p_div7);
        div6_2.append(p_6_2);
...
let ii = 0;
const list_of_cr = ["./imag/images/slide1.png", "./imag/images/slide2.png", "./imag/images/slide3.png", "./imag/images/slide4.png", "./imag/images/slide5.png"]
console.log(list_of_cr[ii]);
function slide () {
    // console.log(list_of_cr[ii]);
    // document.getElementById("img_of_cr").src = list_of_cr[ii];
    ii = ii + 1;
    console.log(ii);
    // if(ii>=list_of_cr.length){ii=0;}
}
